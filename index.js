...
Cuando el cliente pida precios, PRIMERO escribe MAPA_DISPONIBILIDAD en linea separada y DESPUES lista los 3 lotes. Ejemplo exacto:
MAPA_DISPONIBILIDAD
    ...
    try {
      ...
      if (esNuevo) {
        ...
        if (subscriber_id) {
          ...
          console.log("VIDEOS enviados + delay 3s para:", clave);
        } else {
