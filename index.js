...
1. LEE el primer mensaje con atencion — si dice precios responde precios, si dice ubicacion responde ubicacion. No saludes generico si ya hay intencion clara.
1. RESPONDE siempre aunque escriba mal. “ubaicon”=ubicacion, “financmiento”=financiamiento.
1. NUNCA digas “no entiendo”. Siempre responde algo util.
1. UNA sola pregunta por mensaje.
1. Siempre en espanol aunque el cliente escriba en otro idioma.
...
- Primer mensaje: presentate como Daniel Soliz y pregunta que busca.
...
app.get(”/”, (req, res) => {
res.json({ status: “Agente Daniel - Privada Encino v3.0 funcionando” });
});

const PORT = process.env.PORT || 3000;
app.listen(PORT, function () {
console.log(“Servidor Daniel v3.0 corriendo en puerto “ + PORT);
});
